        ...
        <div class="app-page-title">
            <div class="page-title-wrapper d-flex justify-content-between align-items-center">
                <div class="page-title-heading">
                    ...
                    <h5 class="py-3">
                        <span class="text-muted fw-light">Team /</span> List
                    </h5>
                </div>

                <div class="page-title-actions">
                    <a href="{{ URL::to('admin/team/create') }}" class="btn btn-primary">
                            ...
                            @foreach ($model as $value)
                                @if (Auth::user()->EmpRegistration->Emp_Role === '1' ||
                                    ...
                                    <tr>
                                        ...
                                        <td class=""> {{ $value->Pag_Name }}</td>
                                        <td class=""> {{ $value->Pag_ShortDesc }}</td>
                                        <td> {{ $value->Pag_SerialOrder }} </td>
                                        <td class="d-flex">
                                            <a href="{{ route('admin.team.edit', encodeId($value->Pag_Id)) }}"
                                            ...
                                            <span class='me-2'>
                                                @if ($value->Pag_Status == 0)
                                                    <a class="btn btn-success"
                                                        href="{{ URL::to('admin/team/active', $value->Pag_Id) }}"><i
                                                            class="fa fa-check-circle active"></i> </a>
                                                @elseif ($value->Pag_Status == 1)
                                                    <a class="btn btn-danger"
                                                        href="{{ URL::to('admin/team/inactive', $value->Pag_Id) }}"><i
                                            ...
                                            <form action=" {{ route('admin.team.destroy', $value->Pag_Id) }}"
