            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form id="register-form" action="{{ route('admin.slider.store') }}"
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label" for="Title">Title <span
                                                style="color:red">*</span></label>
                                        <div class="input-group input-group-merge">
                                            <input type="text" id="Pag_ShortDesc" name="Pag_ShortDesc"
                                                class="form-control" autocomplete="off" placeholder="Enter your Name"
                                                aria-describedby="name2" />
                                            <span class="input-group-text cursor-pointer p-1" id="name2"><span
                                                    class="card-type"></span></span>
                                        </div>
