    ...
    @if (session('success'))
        ...
        <div class="container-fluid">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="py-3">
                    <span class="text-muted fw-light">Counselling/</span> Add Counselling
                </h5>
            ...
            <div class="row">
                <div class="col-md-12 mx-auto">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form id="register-form" action="{{ route('admin.counselling.store') }}"
