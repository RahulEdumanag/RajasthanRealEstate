...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="py-3">
                <span class="text-muted fw-light">Horoscope/</span> Edit Horoscope
            </h5>
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card mb-4">
                    <div class="card-body">
                        <form id='edit' action="{{ Route('admin.horoscope.update', $model->Pag_Id) }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6 form-group">
                                    <label class="form-label" for="OtherLanguage">Other Language <span
                                            style="color:red">*</span></label>
                                    <div class="input-group input-group-merge">
                                        <textarea id="Pag_ShortDesc" name="Pag_ShortDesc" class="form-control" autocomplete="off" aria-describedby="name2">{{ old('Pag_ShortDesc', $model->Pag_ShortDesc) }}</textarea>
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-12 mb-4">
                                    <label class="form-label" for="Horoscope Image">Horoscope Image <span
                                            style="color:red">*</span></label>
