...
@section('content')
    ...
    <div class="container-fluid">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="py-3">
                <span class="text-muted fw-light">Announcement/</span> Add Announcement
            </h5>
            <div class="page-title-actions">
                <a href="{{ URL::to('admin/error') }}" class="btn btn-primary">
        ...
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card mb-4">
                    <div class="card-body">
                        <form id="register-form" action="{{ route('admin.error.store') }}"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="Pag_Name" name="Pag_Name" class="form-control"
                                            autocomplete="off" placeholder="Enter your Announcement title"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <textarea id="Pag_ShortDesc" name="Pag_ShortDesc" class="form-control" autocomplete="off"
                                            placeholder="Enter your error short description" aria-describedby="name2"></textarea>
