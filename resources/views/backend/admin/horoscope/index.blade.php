    ...
    <div class="container-xxl flex-grow-1 container-p-y card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="page-title-actions">
                <a href="{{ route('admin.horoscope.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-lg"></i> Add Horoscope
                </a>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        @foreach ($model as $value)
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('admin.horoscope.edit', encodeId($value->Pag_Id)) }}"
                                    ...
                                    @if ($value->Pag_AdminExists == 'on' && Auth::user()->EmpRegistration->Emp_Role == '1')
                                        <span class='me-2'>
                                            @if ($value->Pag_Status == 0)
                                                <a class="btn btn-success"
                                                    href="{{ URL::to('admin/horoscope/active', $value->Pag_Id) }}"><i
                                                        class="fa fa-check-circle active"></i>
                                                </a>
                                            @elseif ($value->Pag_Status == 1)
                                                <a class="btn btn-danger"
                                                    href="{{ URL::to('admin/horoscope/inactive', $value->Pag_Id) }}"><i
                                        ...
                                        <form action=" {{ route('admin.horoscope.destroy', $value->Pag_Id) }}"
