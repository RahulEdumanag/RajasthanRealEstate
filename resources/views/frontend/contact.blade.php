                ...
                <div class="contact-bg">
                    <div class="row">
                        <div class="col-md-8 col-sm-7 col-xs-12">
                            <div class="bottom40">
                                <h2 class="text-uppercase">Send us a<span class="color_red"> message </span></h2>
                            ...
                            <form method="post" action="{{ route('contact.Cstore') }}" id="contact-form"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-4 col-xs-12">
                                        ...
                                        <lable style="color:black">Purchase Date</lable>  
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-4 col-xs-12">
                                        <div class="form-group single-query">
                                            <input type="number" name='i_Number2' id="i_Number2" class="keyword-input"
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-4 col-xs-12">
                                        <div class="form-group single-query">
                                            <input type="number" name='i_Number' id="i_Number" class="keyword-input"
