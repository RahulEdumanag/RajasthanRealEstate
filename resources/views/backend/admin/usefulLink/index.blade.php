                ...
                <table class="invoice-list-table table border-top" id="invoiceTable">
                    ...
                    <tbody>
                        @foreach ($model as $value)
                            @if (Auth::user()->EmpRegistration->Emp_Role == '1' || (!$value->Pag_AdminExists && Auth::user()->role !== 'SUPERADMIN'))
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <span class='me-2'>
                                            @if ($value->Pag_Status == 0)
                                                <a class="btn btn-success"
                                                    href="{{ URL::to('admin/usefulLink/active', $value->Pag_Id) }}"><i
                                                        class="fa fa-check-circle active"></i>
                                                </a>
                                            @elseif ($value->Pag_Status == 1)
                                                <a class="btn btn-danger"
                                                    href="{{ URL::to('admin/usefulLink/inactive', $value->Pag_Id) }}"><i
                                        ...
                                        <form action=" {{ route('admin.usefulLink.destroy', $value->Pag_Id) }}"
