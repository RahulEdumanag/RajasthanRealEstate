                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12 mb-4">
                        ...
                        <select class="form-select form-control" id="type" name="type"
                            ...
                            @foreach ($master as $value)
                                <option {{ $submaster->type == $value->title ? 'selected' : '' }}>{{ $value->title }}
                                </option>
                            @endforeach
                        </select>
                        @error('type')
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12 mb-4">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            value="{{ $submaster->title }}" placeholder="" />
                        @error('title')
                    ...
                    <div class="col-xl-6 col-md-6 col-sm-12 mb-4">
                        ...
                        <input type="text" class="form-control" id="value" name="value"
                            value="{{ $submaster->value }}" placeholder="" />
                        @error('value')
                            <span id="error_description" class="has-error">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="image-area mt-4">
                            <img id="imageResult" src="{{ asset('path-to-your-image/' . $submaster->logo) }}"
                                alt="" class="img-fluid rounded shadow-sm mx-auto d-block" style="width: 250px;">
                        </div>
                    </div>
