            ...
            <div class="app-page-title">
                <div class="page-title-wrapper d-flex justify-content-between align-items-center">
                    <div class="page-title-heading">
                        ...
                        <h5 class="py-3">
                            <span class="text-muted fw-light">Service /</span> List
                        </h5>
                    </div>

                    <div class="page-title-actions">
                        <a href="{{ URL::to('admin/service/create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($model as $value)
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('admin.service.edit', encodeId($value->Pag_Id)) }}"
                                            ...
                                            <span class='me-2'>
                                                @if ($value->Pag_Status == 0)
                                                    <a class="btn btn-success"
                                                        href="{{ URL::to('admin/service/active', $value->Pag_Id) }}"><i
                                                            class="fa fa-check-circle active"></i> </a>
                                                @elseif ($value->Pag_Status == 1)
                                                    <a class="btn btn-danger"
                                                        href="{{ URL::to('admin/service/inactive', $value->Pag_Id) }}"><i
                                            ...
                                            <form action=" {{ route('admin.service.destroy', $value->Pag_Id) }}"
