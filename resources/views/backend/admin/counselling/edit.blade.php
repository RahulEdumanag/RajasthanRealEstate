...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="py-3">
                <span class="text-muted fw-light">Counselling/</span> Edit Counselling
            </h5>
            <div class="page-title-actions">
                <a href="{{ URL::to('admin/counselling') }}" class="btn btn-primary">
                    <i class="bi bi-plus-lg"></i> Counselling List
                </a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card mb-4">
                    <div class="card-body">
                        <form id='edit' action="{{ Route('admin.counselling.update', $model->Pag_Id) }}"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <label for="Short Desc" class="form-label">Short Desc<span style="color:red">*</span></label>
