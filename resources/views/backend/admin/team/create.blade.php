...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="py-3">
                <span class="text-muted fw-light">Team/</span> Add Team
            </h5>
            <div class="page-title-actions">
                <a href="{{ URL::to('admin/team') }}" class="btn btn-primary">
                    <i class="bi bi-plus-lg"></i> Team List
                </a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 mx-auto">
                <div class="card mb-4">
                    <div class="card-body">
                        <form id="register-form" action="{{ route('admin.team.store') }}" enctype="multipart/form-data"
