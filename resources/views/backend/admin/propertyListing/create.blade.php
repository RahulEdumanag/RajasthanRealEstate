            ...
            <div class="app-page-title">
                <div class="page-title-wrapper d-flex justify-content-between align-items-center">
                    <div class="page-title-heading">
                        ...
                        <h5 class="py-3">
                            <span class="text-muted fw-light">Property Listing /</span> List
                        </h5>
                    </div>
                            ...
                            @foreach ($model as $value)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <a href="{{ route('admin.propertyListing.edit', encodeId($value->PId)) }}"
                                        ...
                                        <span class='me-2'>
                                            @if ($value->PStatus == 0)
                                                <a class="btn btn-success"
                                                    href="{{ URL::to('admin/propertyListing/active', $value->PId) }}"> <i
                                                        class="fa fa-check-circle active"></i> </a>
                                            @elseif ($value->PStatus == 3)
                                                <a class="btn btn-danger"
                                                    href="{{ URL::to('admin/propertyListing/inactive', $value->PId) }}"> <i
                                        ...
                                        <form action=" {{ route('admin.propertyListing.destroy', $value->PId) }}"
