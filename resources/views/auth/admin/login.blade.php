...
<div class="d-none d-lg-flex col-lg-7 p-0">
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
        ...
        <div class="w-px-400 mx-auto">
            ...
            <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('admin.auth.loginAdmin') }}">
                @csrf
                 <div class="mb-3">
        <label for="Log_Username" class="form-label">Username</label>
        @if ($errors->has('Log_Username'))
            <span class="is-invalid error-text">{{ $errors->first('Log_Username') }}</span>
        @endif
        <input type="text" class="form-control" id="Log_Username" name="Log_Username" value="{{ old('Log_Username') }}" placeholder="Enter your username" autofocus />
    </div>
        ...
        <div class="input-group input-group-merge">
            <input type="password" id="Log_Password" class="form-control" name="Log_Password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="Log_Password" />
            ...
            <p class="text-center">
                ...
                <!-- <a href="{{ URL::to('/admin_login/registration') }}"> -->
