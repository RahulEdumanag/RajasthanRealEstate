                                ...
                                @if (Auth::user()->registration->Reg_Role === 'SUPERADMIN' ||
                                    ...
                                    <tr>
                                        ...
                                        <td class="serial-number" title="{{ $value->PFea_Name }}">
                                            {{ Str::limit($value->PFea_Name, 25) }}
                                        </td>
 
 
                                        <td class="d-flex">
                                            <a href="{{ route('admin.propertyFeatures.edit', encodeId($value->PFea_Id)) }}"
                                            ...
                                            <form action=" {{ route('admin.propertyFeatures.destroy', $value->PFea_Id) }}"
