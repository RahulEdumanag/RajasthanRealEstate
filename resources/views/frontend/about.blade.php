              ...
              <div class="row about_image">
                  <div class="col-md-6">
                      <div class="single-effect3">
                        <a href="#"><img src="images/about-1.jpg" alt="img"></a>
                          <div class="info">
                            <h4>30% Discount</h4> 
                            <p>Only 15 days</p>
                          </div>
                    ...
                    <div class="col-md-6">
                      <div class="single-effect3">
                        <a href="#"><img src="images/about-2.jpg" alt="img"></a>
                          <div class="info">
                            <h4>30% Discount</h4> 
                            <p>Only 15 days</p>
                          </div>         
  ...
  <div class="row">
    ...
    <div class="col-md-8 col-sm-12">
      <div class="call-to-action-img">
        <img src="images/about-page-3.png" alt="image">
      </div>
    </div>
  </div>
</div>
...
<section id="team-sev" class="padding bg_light">
    <div class="container">
      ...
      <div class="row mt-30">
          ...
          <div class="col-md-3 col-sm-3 col-xs-12 text-center">
              <div class="team-box">
                <img src="images/team-6.png" alt="img">
                  <h2>Anita Kutlesa</h2>
                  <p>VP Product</p>
                  <ul>
                    <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12 text-center">
              <div class="team-box">
                <img src="images/team-7.png" alt="img">
                  <h2>Antonios Garnelis</h2>
                  <p>VP Product</p>
                  <ul>
                    <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12 text-center">
              <div class="team-box">
                <img src="images/team-8.png" alt="img">
                  <h2>Antonios Garnelis</h2>
                  <p>VP Product</p>
                  <ul>
                    <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
